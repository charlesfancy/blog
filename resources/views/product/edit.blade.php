                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('product.update', $product->id) }}">
                        ...
                        <div class="form-group{{ $errors->has('manufacture_date') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="manufacture_date" type="date" class="form-control" name="manufacture_date" value="{{ old('manufacture_date', \Carbon\Carbon::parse($product->manufacture_date)->format('Y-m-d')) }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('stock') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="stock" type="number" class="form-control" name="stock" value="{{ old('stock', $product->stock) }}">
